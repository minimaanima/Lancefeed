...
import logo from '../../../images/users/user-1.jpg'
            ...
            <div className='row'>
              <div className='col-md-3 static'>
                <div className='profile-card'>
                  <img src={logo} alt='user' className='profile-photo' />
                  <h5><a href='timeline.html' className='text-white'>Ivan Petrov</a></h5>
                  ...
                  <div className='row'>
                    <div className='col-md-7 col-sm-7'>
                      <div className='form-group'>
                        <img src={logo} alt className='profile-photo-md' />
                ...
                <div className='post-content'>
                  <div className='post-container'>
                    ...
                    <div className='post-detail'>
                      ...
                      <div className='post-comment'>
                        <img src={logo} alt className='profile-photo-sm' />
